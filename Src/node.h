...
struct Node
{
    ...
    int    parent; //backpointer to the predecessor node (e.g. the node which g-value was used to set the g-velue of the current node)
    Node();
  	Node(int, int, double, double, double, int);
};
